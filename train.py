...
if __name__ == '__main__':
    ...
    print(os.path.join(os.popen('').read().strip(), model))

    if not os.path.isdir(os.path.join(os.popen('/home/gpuuser/master/WSNFG').read().strip(), model)):
        print('>>>>>> Creating directory \'model\' ... ')
        os.mkdir(os.path.join(os.popen('/home/gpuuser/master/WSNFG').read().strip(), model))

    path = os.path.join(os.popen('/home/gpuuser/master/WSNFG').read().strip(), model)
